...
class UserPostList(APIView):
    ...
    def get(self, request):
        ...
        serialized_posts = PostGetSerializer(posts, context={"user_id": request.user.id}, many=True)
...
class PostDetail(APIView):
    ...
    def get(self, request, pk):
        ...
        serialized_post = PostGetSerializer(post, context={"user_id": request.user.id})
...
class CommentAPI(APIView):
    ...
    def get(self, request, pk):
        ...
        serialized_comments = CommentGetSerializer(comments, context={"user_id": request.user.id}, many=True)
...
class NewsfeedAPI(APIView, LimitOffsetPagination):
    ...
    def get(self, request):
        ...
        serialized_pqs = PostGetSerializer(pqs, context={"user_id": request.user.id}, many=True)
